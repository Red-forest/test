...
var _bucketname = 'friend-album', _username = 'huabinglan', _password = md5('huabinglan@@227');
...
var UPYun = function (bucketname, username, password) {
	_bucketname = bucketname ? bucketname : _bucketname;
	_username = username ? username : _username;
	_password = password ? md5(password) : _password;
}
